(deftheme poggers
  "Theme based on my i3-gaps rice and misterioso")
...
(custom-theme-set-faces
 ...
 '(fringe ((t (:background "#1d2c3f"))))
 '(header-line ((t (:foreground "#333333" :background "#808080"))))
 '(tooltip ((((class color)) (:inherit (variable-pitch) :foreground "black" :background "lightyellow")) (t (:inherit (variable-pitch)))))
 '(mode-line ((t (:background "#0c1b2e" :foreground "#eeeeec"))))
 ...
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#1d2c3f" :foreground "#e1e1e0" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "ADBO" :family "Source Code Pro")))))

(provide-theme 'poggers)
